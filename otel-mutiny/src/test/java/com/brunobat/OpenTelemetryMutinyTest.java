...
public class OpenTelemetryMutinyTest {
    ...
    @Disabled
    @Test
    void multiGroupTest_main() {
        testStreamTracing_main(testProducer::emitItem2, testReceiver.receive());
    }

    @Test
    void multiGroupTest_vertx() {
        testStreamTracing_vertx(testProducer::emitItem2, testReceiver.receive());
    }

    void testStreamTracing_main(Consumer<String> emitItem, Multi<Tuple3<String, String, String>> processedItems) {
    ...
    void testStreamTracing_vertx(Consumer<String> emitItem, Multi<Tuple3<String, String, String>> processedItems) {
        ...
        VertxContext.createNewDuplicatedContext(context).runOnContext(event -> {
            emitItem.accept("a1");
            emitItem.accept("a2");
        });
